...
func (_m *MockDatabase) BatchInsert(ctx context.Context, data []map[string]any, sql string) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, []map[string]any, string) error); ok {
		r0 = rf(ctx, data, sql)
	} else {
		r0 = ret.Error(0)
	}
