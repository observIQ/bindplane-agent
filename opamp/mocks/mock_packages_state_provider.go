...
type NewPackagesStateProviderT interface {
	mock.TestingT
	Cleanup(func())
}

// NewMockPackagesStateProvider creates a new instance of PackagesStateProvider. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockPackagesStateProvider(t NewPackagesStateProviderT) *MockPackagesStateProvider {
