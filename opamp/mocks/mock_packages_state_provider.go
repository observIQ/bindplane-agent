...
type mockConstructorTestingTNewMockPackagesStateProvider interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockPackagesStateProvider(t mockConstructorTestingTNewMockPackagesStateProvider) *MockPackagesStateProvider {
