...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/extension/storage/filestorage v0.113.0 // indirect
	...
	go.opentelemetry.io/collector/confmap/provider/httpsprovider v1.19.0 // indirect
