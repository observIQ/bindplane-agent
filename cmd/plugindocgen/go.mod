...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/extension/storage/filestorage v0.115.0 // indirect
	...
	go.opentelemetry.io/collector/confmap/provider/httpsprovider v1.21.0 // indirect
