...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/extension/storage/filestorage v0.104.0 // indirect
	...
	go.opentelemetry.io/collector/confmap/provider/httpsprovider v0.104.0 // indirect
