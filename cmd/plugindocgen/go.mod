...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/extension/storage v0.72.0 // indirect
	...
	go.opentelemetry.io/collector/component v0.72.1-0.20230303235035-7318c14f1a2b // indirect
