...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/extension/storage/filestorage v0.109.0 // indirect
	...
	go.opentelemetry.io/collector/confmap/provider/envprovider v0.109.0 // indirect
	go.opentelemetry.io/collector/confmap/provider/fileprovider v1.15.0 // indirect
	go.opentelemetry.io/collector/confmap/provider/httpsprovider v0.109.0 // indirect
