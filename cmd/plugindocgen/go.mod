...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/extension/storage/filestorage v0.95.0 // indirect
	...
	go.opentelemetry.io/collector/otelcol v0.95.0 // indirect
