...
require (
	...
	github.com/observiq/bindplane-agent/exporter/azureblobexporter v1.55.0
	github.com/observiq/bindplane-agent/exporter/chronicleexporter v1.55.0
	github.com/observiq/bindplane-agent/exporter/chronicleforwarderexporter v1.55.0
	...
	github.com/observiq/bindplane-agent/processor/logcountprocessor v1.55.0
	github.com/observiq/bindplane-agent/processor/logdeduplicationprocessor v1.55.0
	github.com/observiq/bindplane-agent/processor/lookupprocessor v1.55.0
	github.com/observiq/bindplane-agent/processor/maskprocessor v1.55.0
	github.com/observiq/bindplane-agent/processor/metricextractprocessor v1.55.0
	github.com/observiq/bindplane-agent/processor/metricstatsprocessor v1.55.0
	github.com/observiq/bindplane-agent/processor/removeemptyvaluesprocessor v1.55.0
	github.com/observiq/bindplane-agent/processor/resourceattributetransposerprocessor v1.55.0
	github.com/observiq/bindplane-agent/processor/samplingprocessor v1.55.0
	github.com/observiq/bindplane-agent/processor/spancountprocessor v1.55.0
	github.com/observiq/bindplane-agent/processor/throughputmeasurementprocessor v1.55.0
	github.com/observiq/bindplane-agent/receiver/awss3rehydrationreceiver v1.55.0
	github.com/observiq/bindplane-agent/receiver/azureblobrehydrationreceiver v1.55.0
	github.com/observiq/bindplane-agent/receiver/httpreceiver v1.55.0
	github.com/observiq/bindplane-agent/receiver/m365receiver v1.55.0
	github.com/observiq/bindplane-agent/receiver/pluginreceiver v1.55.0
	github.com/observiq/bindplane-agent/receiver/routereceiver v1.55.0
