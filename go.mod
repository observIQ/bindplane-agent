...
require (
	...
	github.com/observiq/bindplane-agent/exporter/googlecloudexporter v1.32.0
	github.com/observiq/bindplane-agent/exporter/googlemanagedprometheusexporter v1.32.0
	github.com/observiq/bindplane-agent/packagestate v1.32.0
	github.com/observiq/bindplane-agent/processor/datapointcountprocessor v1.32.0
	github.com/observiq/bindplane-agent/processor/logcountprocessor v1.32.0
	github.com/observiq/bindplane-agent/processor/logdeduplicationprocessor v1.32.0
	github.com/observiq/bindplane-agent/processor/maskprocessor v1.32.0
	github.com/observiq/bindplane-agent/processor/metricextractprocessor v1.32.0
	github.com/observiq/bindplane-agent/processor/metricstatsprocessor v1.32.0
	github.com/observiq/bindplane-agent/processor/removeemptyvaluesprocessor v1.32.0
	github.com/observiq/bindplane-agent/processor/resourceattributetransposerprocessor v1.32.0
	github.com/observiq/bindplane-agent/processor/samplingprocessor v1.32.0
	github.com/observiq/bindplane-agent/processor/spancountprocessor v1.32.0
	github.com/observiq/bindplane-agent/processor/throughputmeasurementprocessor v1.32.0
	github.com/observiq/bindplane-agent/receiver/apachedruidreceiver v1.32.0
	github.com/observiq/bindplane-agent/receiver/m365receiver v1.32.0
	github.com/observiq/bindplane-agent/receiver/pluginreceiver v1.32.0
	github.com/observiq/bindplane-agent/receiver/routereceiver v1.32.0
	github.com/observiq/bindplane-agent/receiver/sapnetweaverreceiver v1.32.0
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/connector/spanmetricsconnector v0.82.0
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/exporter/awss3exporter v0.82.0
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/receiver/cloudflarereceiver v0.82.0
...
require (
	...
	github.com/observiq/bindplane-agent/counter v1.32.0 // indirect
	github.com/observiq/bindplane-agent/expr v1.32.0 // indirect
	github.com/open-telemetry/opentelemetry-collector-contrib/exporter/googlemanagedprometheusexporter v0.82.0 // indirect
	github.com/open-telemetry/opentelemetry-collector-contrib/processor/servicegraphprocessor v0.82.0 // indirect
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/pdatautil v0.82.0 // indirect; indir2ct
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/filter v0.82.0 // indirect; indir2ct
)
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/exporter/googlecloudexporter v0.82.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/awsutil v0.82.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/containerinsight v0.82.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/cwlogs v0.82.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/ecsutil v0.82.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/k8s v0.82.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/metrics v0.82.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/proxy v0.82.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/xray v0.82.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/common v0.82.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/coreinternal v0.82.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/docker v0.82.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/k8sconfig v0.82.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/kubelet v0.82.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/metadataproviders v0.82.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/sharedcomponent v0.82.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/splunk v0.82.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/batchperresourceattr v0.82.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/batchpersignal v0.82.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/experimentalmetricmetadata v0.82.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/ottl v0.82.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/resourcetotelemetry v0.82.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/stanza v0.82.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/jaeger v0.82.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/loki v0.82.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/opencensus v0.82.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/prometheus v0.82.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/prometheusremotewrite v0.82.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/signalfx v0.82.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/zipkin v0.82.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/winperfcounters v0.82.0 // indirect; indi72.0
	...
	go.opentelemetry.io/collector/semconv v0.82.0 // indirect; indir7.0
...
replace github.com/observiq/bindplane-agent/receiver/apachedruidreceiver => ./receiver/apachedruidreceiver
