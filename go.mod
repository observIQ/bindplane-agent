...
require (
	...
	github.com/observiq/bindplane-otel-collector/exporter/azureblobexporter v1.66.0
	github.com/observiq/bindplane-otel-collector/exporter/chronicleexporter v1.66.0
	github.com/observiq/bindplane-otel-collector/exporter/chronicleforwarderexporter v1.66.0
	github.com/observiq/bindplane-otel-collector/exporter/googlecloudexporter v1.66.0
	github.com/observiq/bindplane-otel-collector/exporter/googlemanagedprometheusexporter v1.66.0
	github.com/observiq/bindplane-otel-collector/exporter/qradar v1.66.0
	github.com/observiq/bindplane-otel-collector/exporter/snowflakeexporter v1.66.0
	github.com/observiq/bindplane-otel-collector/internal/measurements v1.66.0
	github.com/observiq/bindplane-otel-collector/internal/report v1.66.0
	github.com/observiq/bindplane-otel-collector/packagestate v1.66.0
	github.com/observiq/bindplane-otel-collector/processor/datapointcountprocessor v1.66.0
	github.com/observiq/bindplane-otel-collector/processor/logcountprocessor v1.66.0
	github.com/observiq/bindplane-otel-collector/processor/lookupprocessor v1.66.0
	github.com/observiq/bindplane-otel-collector/processor/maskprocessor v1.66.0
	github.com/observiq/bindplane-otel-collector/processor/metricextractprocessor v1.66.0
	github.com/observiq/bindplane-otel-collector/processor/metricstatsprocessor v1.66.0
	github.com/observiq/bindplane-otel-collector/processor/removeemptyvaluesprocessor v1.66.0
	github.com/observiq/bindplane-otel-collector/processor/resourceattributetransposerprocessor v1.66.0
	github.com/observiq/bindplane-otel-collector/processor/samplingprocessor v1.66.0
	github.com/observiq/bindplane-otel-collector/processor/spancountprocessor v1.66.0
	github.com/observiq/bindplane-otel-collector/processor/throughputmeasurementprocessor v1.66.0
	github.com/observiq/bindplane-otel-collector/processor/unrollprocessor v1.66.0
	github.com/observiq/bindplane-otel-collector/receiver/awss3rehydrationreceiver v1.66.0
	github.com/observiq/bindplane-otel-collector/receiver/azureblobrehydrationreceiver v1.66.0
	github.com/observiq/bindplane-otel-collector/receiver/httpreceiver v1.66.0
	github.com/observiq/bindplane-otel-collector/receiver/m365receiver v1.66.0
	github.com/observiq/bindplane-otel-collector/receiver/oktareceiver v1.66.0
	...
	github.com/observiq/bindplane-otel-collector/receiver/sapnetweaverreceiver v1.66.0
	github.com/observiq/bindplane-otel-collector/receiver/telemetrygeneratorreceiver v1.66.0
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/connector/servicegraphconnector v0.114.0
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/exporter/awskinesisexporter v0.114.0
...
require (
	...
	github.com/aerospike/aerospike-client-go/v7 v7.7.2 // indirect
	...
	github.com/observiq/bindplane-otel-collector/counter v1.66.0 // indirect
	github.com/observiq/bindplane-otel-collector/expr v1.66.0 // indirect
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/sqlquery v0.114.0 // indirect
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/azurelogs v0.114.0 // indirect
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/pdatautil v0.114.0 // indirect; indir2ct
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/filter v0.114.0 // indirect; indir2ct
)
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/exporter/googlecloudexporter v0.114.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/awsutil v0.114.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/containerinsight v0.114.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/cwlogs v0.114.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/ecsutil v0.114.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/k8s v0.114.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/metrics v0.114.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/proxy v0.114.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/xray v0.114.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/common v0.114.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/coreinternal v0.114.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/docker v0.114.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/k8sconfig v0.114.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/kubelet v0.114.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/metadataproviders v0.114.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/sharedcomponent v0.114.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/splunk v0.114.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/batchperresourceattr v0.114.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/batchpersignal v0.114.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/experimentalmetricmetadata v0.114.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/ottl v0.114.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/resourcetotelemetry v0.114.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/stanza v0.114.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/jaeger v0.114.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/loki v0.114.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/opencensus v0.114.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/prometheus v0.114.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/prometheusremotewrite v0.114.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/signalfx v0.114.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/zipkin v0.114.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/winperfcounters v0.114.0 // indirect; indi72.0
	...
	go.opentelemetry.io/collector/semconv v0.114.0 // indirect; indir7.0
