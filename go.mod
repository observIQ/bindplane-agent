...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/receiver/filelogreceiver v0.41.0
	github.com/open-telemetry/opentelemetry-collector-contrib/receiver/jmxreceiver v0.37.0
