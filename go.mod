...
require (
	...
	github.com/observiq/observiq-otel-collector/exporter/googlecloudexporter v1.30.0
	github.com/observiq/observiq-otel-collector/exporter/googlemanagedprometheusexporter v1.30.0
	github.com/observiq/observiq-otel-collector/packagestate v1.30.0
	github.com/observiq/observiq-otel-collector/processor/datapointcountprocessor v1.30.0
	github.com/observiq/observiq-otel-collector/processor/logcountprocessor v1.30.0
	github.com/observiq/observiq-otel-collector/processor/logdeduplicationprocessor v1.30.0
	github.com/observiq/observiq-otel-collector/processor/maskprocessor v1.30.0
	github.com/observiq/observiq-otel-collector/processor/metricextractprocessor v1.30.0
	github.com/observiq/observiq-otel-collector/processor/metricstatsprocessor v1.30.0
	github.com/observiq/observiq-otel-collector/processor/removeemptyvaluesprocessor v1.30.0
	github.com/observiq/observiq-otel-collector/processor/resourceattributetransposerprocessor v1.30.0
	github.com/observiq/observiq-otel-collector/processor/samplingprocessor v1.30.0
	github.com/observiq/observiq-otel-collector/processor/spancountprocessor v1.30.0
	github.com/observiq/observiq-otel-collector/processor/throughputmeasurementprocessor v1.30.0
	github.com/observiq/observiq-otel-collector/receiver/m365receiver v1.30.0
	github.com/observiq/observiq-otel-collector/receiver/apachedruidreceiver v1.30.0
	...
	github.com/observiq/observiq-otel-collector/receiver/sapnetweaverreceiver v1.30.0
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/exporter/awss3exporter v0.81.0
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/processor/logstransformprocessor v0.81.0
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/receiver/cloudflarereceiver v0.81.0
...
require (
	...
	github.com/observiq/observiq-otel-collector/counter v1.30.0 // indirect
	github.com/observiq/observiq-otel-collector/expr v1.30.0 // indirect
	github.com/open-telemetry/opentelemetry-collector-contrib/exporter/googlemanagedprometheusexporter v0.81.0 // indirect
	github.com/open-telemetry/opentelemetry-collector-contrib/processor/servicegraphprocessor v0.81.0 // indirect
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/pdatautil v0.81.0 // indirect; indir2ct
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/filter v0.81.0 // indirect; indir2ct
)
...
require (
	...
	github.com/GoogleCloudPlatform/opentelemetry-operations-go/exporter/collector v0.40.1 // indirect
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/exporter/googlecloudexporter v0.81.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/awsutil v0.81.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/containerinsight v0.81.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/cwlogs v0.81.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/ecsutil v0.81.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/k8s v0.81.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/metrics v0.81.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/proxy v0.81.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/xray v0.81.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/common v0.81.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/coreinternal v0.81.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/docker v0.81.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/k8sconfig v0.81.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/kubelet v0.81.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/metadataproviders v0.81.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/sharedcomponent v0.81.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/splunk v0.81.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/batchperresourceattr v0.81.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/batchpersignal v0.81.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/experimentalmetricmetadata v0.81.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/ottl v0.81.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/resourcetotelemetry v0.81.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/stanza v0.81.1-0.20230710164028-4874893a9395 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/jaeger v0.81.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/loki v0.81.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/opencensus v0.81.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/prometheus v0.81.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/prometheusremotewrite v0.81.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/signalfx v0.81.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/zipkin v0.81.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/winperfcounters v0.81.0 // indirect; indi72.0
	...
	go.mongodb.org/atlas v0.30.0 // indirect
	go.mongodb.org/mongo-driver v1.12.0 // indirect
	go.opentelemetry.io/collector/semconv v0.81.0 // indirect; indir7.0
