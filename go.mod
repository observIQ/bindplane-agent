...
require (
	...
	github.com/observiq/observiq-otel-collector/processor/routerprocessor v1.14.0
...
replace github.com/observiq/observiq-otel-collector/processor/routerprocessor => ./processor/routerprocessor
