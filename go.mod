...
require (
	...
	github.com/observiq/bindplane-agent/exporter/azureblobexporter v1.43.0
	github.com/observiq/bindplane-agent/exporter/chronicleexporter v1.43.0
	github.com/observiq/bindplane-agent/exporter/chronicleforwarderexporter v1.43.0
	github.com/observiq/bindplane-agent/exporter/googlecloudexporter v1.43.0
	github.com/observiq/bindplane-agent/exporter/googlemanagedprometheusexporter v1.43.0
	github.com/observiq/bindplane-agent/packagestate v1.43.0
	github.com/observiq/bindplane-agent/processor/datapointcountprocessor v1.43.0
	github.com/observiq/bindplane-agent/processor/logcountprocessor v1.43.0
	github.com/observiq/bindplane-agent/processor/logdeduplicationprocessor v1.43.0
	github.com/observiq/bindplane-agent/processor/maskprocessor v1.43.0
	github.com/observiq/bindplane-agent/processor/metricextractprocessor v1.43.0
	github.com/observiq/bindplane-agent/processor/metricstatsprocessor v1.43.0
	github.com/observiq/bindplane-agent/processor/removeemptyvaluesprocessor v1.43.0
	github.com/observiq/bindplane-agent/processor/resourceattributetransposerprocessor v1.43.0
	github.com/observiq/bindplane-agent/processor/samplingprocessor v1.43.0
	github.com/observiq/bindplane-agent/processor/spancountprocessor v1.43.0
	github.com/observiq/bindplane-agent/processor/throughputmeasurementprocessor v1.43.0
	github.com/observiq/bindplane-agent/receiver/azureblobrehydrationreceiver v1.43.0
	github.com/observiq/bindplane-agent/receiver/httpreceiver v1.43.0
	github.com/observiq/bindplane-agent/receiver/m365receiver v1.43.0
	github.com/observiq/bindplane-agent/receiver/pluginreceiver v1.43.0
	github.com/observiq/bindplane-agent/receiver/routereceiver v1.43.0
	github.com/observiq/bindplane-agent/receiver/sapnetweaverreceiver v1.43.0
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/processor/logstransformprocessor v0.91.0
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/pdatautil v0.91.0 // indirect; indir2ct
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/filter v0.91.0 // indirect; indir2ct
)
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/exporter/googlecloudexporter v0.91.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/awsutil v0.91.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/containerinsight v0.91.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/cwlogs v0.91.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/ecsutil v0.91.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/k8s v0.91.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/metrics v0.91.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/proxy v0.91.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/xray v0.91.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/common v0.91.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/coreinternal v0.91.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/docker v0.91.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/k8sconfig v0.91.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/kubelet v0.91.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/metadataproviders v0.91.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/sharedcomponent v0.91.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/splunk v0.91.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/batchperresourceattr v0.91.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/batchpersignal v0.91.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/experimentalmetricmetadata v0.91.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/ottl v0.91.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/resourcetotelemetry v0.91.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/stanza v0.91.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/jaeger v0.91.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/loki v0.91.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/opencensus v0.91.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/prometheus v0.91.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/prometheusremotewrite v0.91.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/signalfx v0.91.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/zipkin v0.91.0 // indirect; indi72.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/winperfcounters v0.91.0 // indirect; indi72.0
	...
	go.opentelemetry.io/collector/semconv v0.91.0 // indirect; indir7.0
