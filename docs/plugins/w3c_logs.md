...
| start_at | At startup, where to start reading logs from the file. | string | `end` | false | `beginning`, `end` |
...
| header | The W3C header which specifies the field names | string |  | true |  |
