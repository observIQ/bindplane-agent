...
import (
	models "github.com/observiq/bindplane-otel-collector/receiver/sapnetweaverreceiver/internal/models"
...
func (_m *MockWebService) ABAPGetSystemWPTable() (*models.ABAPGetSystemWPTableResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func() (*models.ABAPGetSystemWPTableResponse, error)); ok {
		return rf()
	}
...
// CertExecute provides a mock function with given fields: command
func (_m *MockWebService) CertExecute(command string) ([]string, error) {
...
func (_m *MockWebService) EnqGetStatistic() (*models.EnqGetStatisticResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func() (*models.EnqGetStatisticResponse, error)); ok {
		return rf()
	}
...
func (_m *MockWebService) GetAlertTree() (*models.GetAlertTreeResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func() (*models.GetAlertTreeResponse, error)); ok {
		return rf()
	}
...
func (_m *MockWebService) GetInstanceProperties() (*models.GetInstancePropertiesResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func() (*models.GetInstancePropertiesResponse, error)); ok {
		return rf()
	}
...
func (_m *MockWebService) GetProcessList() (*models.GetProcessListResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func() (*models.GetProcessListResponse, error)); ok {
		return rf()
	}
...
func (_m *MockWebService) GetQueueStatistic() (*models.GetQueueStatisticResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func() (*models.GetQueueStatisticResponse, error)); ok {
		return rf()
	}
...
func (_m *MockWebService) GetSystemInstanceList() (*models.GetSystemInstanceListResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func() (*models.GetSystemInstanceListResponse, error)); ok {
		return rf()
	}
