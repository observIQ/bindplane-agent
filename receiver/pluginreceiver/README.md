...
**Note**: The value given for the timezone parameter type must be a standard UTC timezone, shown in this [timezone list](https://github.com/observIQ/observiq-otel-collector/blob/main/receiver/pluginreceiver/timezone.md).
