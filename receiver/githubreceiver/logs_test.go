...
func mockAPIResponseOK100LogsEnterprise(t *testing.T) *http.Response {
	...
	mockRes.Header.Add("Link", mockLinkHeaderNextEnterprise)
	mockRes.Header.Add("Link", mockLinkHeaderLastEnterprise)
	mockRes.Body = io.NopCloser(strings.NewReader(jsonFileAsString(t, "testdata/gitHubResponse100LogsEnterprise.json")))
	return mockRes
}
...
func TestPollBasicOrganization(t *testing.T) {
	...
	// golden.WriteLogs(t, "testdata/plog_org.yaml", log)
	expected, err := golden.ReadLogs("testdata/plog_org.yaml")
	require.NoError(t, err)
	require.NoError(t, plogtest.CompareLogs(expected, log, plogtest.IgnoreObservedTimestamp()))
...
func mockAPIResponseOKBasicOrganization(t *testing.T) *http.Response {
	...
	mockRes.Body = io.NopCloser(strings.NewReader(jsonFileAsString(t, "testdata/gitHubResponseBasicOrganization.json")))
	return mockRes
}
...
func mockAPIResponseOK24LogsOrganization(t *testing.T) *http.Response {
	...
	mockRes.Header.Add("Link", mockLinkHeaderNextOrganization)
	mockRes.Header.Add("Link", mockLinkHeaderLastOrganization)
	mockRes.Body = io.NopCloser(strings.NewReader(jsonFileAsString(t, "testdata/gitHubResponse24LogsOrganization.json")))
	return mockRes
}
...
func TestPollBasicUser(t *testing.T) {
	...
	// golden.WriteLogs(t, "testdata/plog_user.yaml", log)
	expected, err := golden.ReadLogs("testdata/plog_user.yaml")
	require.NoError(t, err)
	require.NoError(t, plogtest.CompareLogs(expected, log, plogtest.IgnoreObservedTimestamp()))
...
func mockAPIResponseOKBasicUser(t *testing.T) *http.Response {
	...
	mockRes.Body = io.NopCloser(strings.NewReader(jsonFileAsString(t, "testdata/gitHubResponseBasicUser.json")))
	return mockRes
}
...
func mockAPIResponseOK30LogsUser(t *testing.T) *http.Response {
	...
	mockRes.Header.Add("Link", mockLinkHeaderNextUser)
	mockRes.Header.Add("Link", mockLinkHeaderLastUser)
	mockRes.Body = io.NopCloser(strings.NewReader(jsonFileAsString(t, "testdata/gitHubResponse30LogsUser.json")))
	return mockRes
}
