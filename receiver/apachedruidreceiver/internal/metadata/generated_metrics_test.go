...
func TestMetricsBuilder(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			attrCount++
			assert.Equal(t, mb.resourceAttributesConfig.ApachedruidService.Enabled, ok)
			if mb.resourceAttributesConfig.ApachedruidService.Enabled {
				enabledAttrCount++
			...
			for i := 0; i < ms.Len(); i++ {
				...
				case "apachedruid.average_sql_query_bytes":
					...
					assert.Equal(t, "Average number of bytes returned by a SQL query.", ms.At(i).Description())
				...
				case "apachedruid.average_sql_query_time":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, ms.At(i).Type())
					assert.Equal(t, 1, ms.At(i).Gauge().DataPoints().Len())
					assert.Equal(t, "Average number of milliseconds taken to complete a SQL query.", ms.At(i).Description())
				...
				case "apachedruid.interrupted_query_count":
					...
					assert.Equal(t, pmetric.MetricTypeSum, ms.At(i).Type())
					assert.Equal(t, 1, ms.At(i).Sum().DataPoints().Len())
					assert.Equal(t, "Number of interrupted queries.", ms.At(i).Description())
					assert.Equal(t, "{ query }", ms.At(i).Unit())
					assert.Equal(t, false, ms.At(i).Sum().IsMonotonic())
					assert.Equal(t, pmetric.AggregationTemporalityCumulative, ms.At(i).Sum().AggregationTemporality())
					dp := ms.At(i).Sum().DataPoints().At(0)
				...
				case "apachedruid.query_count":
					...
					assert.Equal(t, pmetric.MetricTypeSum, ms.At(i).Type())
					assert.Equal(t, 1, ms.At(i).Sum().DataPoints().Len())
					assert.Equal(t, "Number of queries executed.", ms.At(i).Description())
					assert.Equal(t, "{ query }", ms.At(i).Unit())
					assert.Equal(t, false, ms.At(i).Sum().IsMonotonic())
					assert.Equal(t, pmetric.AggregationTemporalityCumulative, ms.At(i).Sum().AggregationTemporality())
					dp := ms.At(i).Sum().DataPoints().At(0)
				...
				case "apachedruid.sql_query_count":
					...
					assert.Equal(t, pmetric.MetricTypeSum, ms.At(i).Type())
					assert.Equal(t, 1, ms.At(i).Sum().DataPoints().Len())
					assert.Equal(t, "Number of SQL queries executed.", ms.At(i).Description())
					assert.Equal(t, "{ sql_query }", ms.At(i).Unit())
					assert.Equal(t, false, ms.At(i).Sum().IsMonotonic())
					assert.Equal(t, pmetric.AggregationTemporalityCumulative, ms.At(i).Sum().AggregationTemporality())
					dp := ms.At(i).Sum().DataPoints().At(0)
					assert.Equal(t, start, dp.StartTimestamp())
				...
				case "apachedruid.success_query_count":
					...
					assert.Equal(t, pmetric.MetricTypeSum, ms.At(i).Type())
					assert.Equal(t, 1, ms.At(i).Sum().DataPoints().Len())
					assert.Equal(t, "Number of successful queries.", ms.At(i).Description())
					assert.Equal(t, "{ query }", ms.At(i).Unit())
					assert.Equal(t, false, ms.At(i).Sum().IsMonotonic())
					assert.Equal(t, pmetric.AggregationTemporalityCumulative, ms.At(i).Sum().AggregationTemporality())
					dp := ms.At(i).Sum().DataPoints().At(0)
