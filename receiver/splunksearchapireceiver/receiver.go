...
func (ssapir *splunksearchapireceiver) getSplunkSearchResults(config *Config, sid string, offset int) (SearchResults, error) {
	resp, err := ssapir.getSearchResults(config, sid, offset)
	if err != nil {
