...
func NewThroughputMeasurements(mp metric.MeterProvider, component, processorID string, extraAttributes map[string]string) (*ThroughputMeasurements, error) {
	meter := mp.Meter("github.com/observiq/bindplane-agent/internal/measurements")

	logSize, err := meter.Int64Counter(
		processorhelper.BuildCustomMetricName(component, "log_data_size"),
	...
	metricSize, err := meter.Int64Counter(
		processorhelper.BuildCustomMetricName(component, "metric_data_size"),
	...
	traceSize, err := meter.Int64Counter(
		processorhelper.BuildCustomMetricName(component, "trace_data_size"),
	...
	logCount, err := meter.Int64Counter(
		processorhelper.BuildCustomMetricName(component, "log_count"),
	...
	datapointCount, err := meter.Int64Counter(
		processorhelper.BuildCustomMetricName(component, "metric_count"),
	...
	spanCount, err := meter.Int64Counter(
		processorhelper.BuildCustomMetricName(component, "trace_count"),
