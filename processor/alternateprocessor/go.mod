module github.com/observiq/observiq-otel-collector/processor/alternateprocessor

go 1.18

require (
	github.com/observiq/observiq-otel-collector/receiver/routereceiver v0.0.0-00010101000000-000000000000
