module github.com/observiq/observiq-otel-collector/processor/spancountprocessor

go 1.19

require (
	github.com/observiq/observiq-otel-collector/counter v1.23.0
	github.com/observiq/observiq-otel-collector/expr v1.23.0
