...
func TestAggregateTypeNewInvalidType(t *testing.T) {
	dp := pmetric.NewNumberDataPoint()
	dp.SetDoubleValue(2.0)
	_, err := AggregateType("invalid").New(dp)
